...
class Template {
    ...
    public function admin_render($content, $data = NULL)
    {
        ...
        {
            //Extras para dar ECHO dentro de Header e Footer
            $data['header_extras']   = $this->CI->load->view('admin/_templates/header_extras', $data, TRUE);
            $data['footer_extras']   = $this->CI->load->view('admin/_templates/footer_extras', $data, TRUE);

            // Tudo que tem o parametro true é apenas armazenado e não renderizado, dá o echo dentro do template
