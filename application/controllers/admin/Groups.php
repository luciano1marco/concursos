...
class Groups extends Admin_Controller {
	...
	public function create()
	{
		...
		/* Validate form input */
		$this->form_validation->set_rules('group_name', 'Grupo Nome', 'required|alpha_dash');
		$this->form_validation->set_rules('group_description', 'Grupo Descrição', 'required|alpha_dash');
		
		if ($this->form_validation->run() == TRUE)
		{
			$new_group_id = $this->ion_auth->create_group($this->input->post('group_name'), $this->input->post('group_description'), $this->input->post('cor'));
			if ($new_group_id)
			{
		...
		else
		{
			...
			$this->data['group_bgcolor'] = array(
				...
				'data-color'		=> $this->form_validation->set_value('cor','FFF')
			);		
