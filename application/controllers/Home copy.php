...
class Home extends Public_Controller {
	...
	public function index($at = null) {      
        ...
        // select para todos os concursos,pss,psi,pse
        $sqlcon ="SELECT dep.sigla as descdep,
        ...
        //select para ativos
        $sqlcona ="SELECT dep.sigla as descdep,
                            dep.descricao as descdesc,
                            ti.sigla as siti,
                            ti.descricao as desctitulo,
                            con.id as idcon,
        ...
        // select para inativos
        $sqlconi ="SELECT dep.sigla as descdep,
                        dep.descricao as descdesc,
                        ti.sigla as siti,
                        ti.descricao as desctitulo,
                        con.id as idcon,
       ...
       // select para processo seletivo simplificado
       $sel1 ="SELECT dep.sigla as descdep,
                        dep.descricao as descdesc,
                        ti.sigla as siti,
                        ti.descricao as desctitulo,
                        con.id as idcon,
       ...
       //select para processo seletivo estagiario
        $sel2 ="SELECT dep.sigla as descdep,
                dep.descricao as descdesc,
                ti.sigla as siti,
                ti.descricao as desctitulo,
                con.id as idcon,
        ...
        //select para concurso publico
        $sel3 ="SELECT dep.sigla as descdep,
                dep.descricao as descdesc,
                ti.sigla as siti,
                ti.descricao as desctitulo,
                con.id as idcon,
        ...
        // select para processo seletivo interno
        $sel4 ="SELECT dep.sigla as descdep,
                dep.descricao as descdesc,
                ti.sigla as siti,
                ti.descricao as desctitulo,
                con.id as idcon,
        ...
        //----conhome é o que chama em meiogeral.php----------------------------
        $this->data['conhome'] = R::getAll($sqlcon);	     
        if($at == "a") $this->data['conhome'] = R::getAll($sqlcona);//ativos
        if($at == "i") $this->data['conhome'] = R::getAll($sqlconi);//inativos
        
        if($at == "1") $this->data['conhome'] = R::getAll($sel1);//ps simplificado
        if($at == "2") $this->data['conhome'] = R::getAll($sel2);//ps estagiario
        if($at == "3") $this->data['conhome'] = R::getAll($sel3);//concurso publico
        if($at == "4") $this->data['conhome'] = R::getAll($sel4);//ps interno
