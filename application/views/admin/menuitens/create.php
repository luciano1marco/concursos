    ...
    <div class="content-wrapper">
        ...
        <div class="card card-primary card-outline">
                <div class="card-header">     
                    <h3 class="card-title">Criar Itens</h3>      
                ...
                <?php echo form_open(current_url(), array('class' => 'form-horizontal', 'id' => 'form-create')); ?>
                    ...
                    <div class="form-group row">                                           
                    <label class="col-sm-2 col-form-label text-right" for="icone">Ícone</label>                           
                        <div class="col-sm-10">                                   
                            <?php echo form_dropdown($icone);?>
                            <div class="icone_erro" id="icone_erro"></div> 
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right" for="section">Sessão</label>                                
                        <div class="col-sm-10">
                            <?php echo form_dropdown($section);?>
                            <div class="section_erro" id="section_erro"></div> 
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-right">Grupos</label>
                        <div class="col-sm-10">
                        
                        <?php foreach ($groups as $group):?>
                            <div class="form-check">
                                <label>
                                    <input type="checkbox" class="form-check-input" name="groups[]" value="<?php echo $group['id']; ?>" />                                           
                                    <?php echo $group['name']; ?>
                                </label>
                            </div>
                        <?php endforeach?>
