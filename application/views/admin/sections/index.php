		...
		<div class="content-header">        
			<div class="container-fluid">
				...
				<div class="col-sm-6">
					...
					<li class="breadcrumb-item">Sessões de Menu</li>
				...
				<div class="row">
					...
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">							
								<?php                        
									$addsession = '<i class="fa fa-plus"></i> Criar Sessão';
									$link = base_url($anchor.'/create/');                                                 
								?>                               
								<?php echo anchor($link, $addsession, array('class' => 'btn btn-primary no-print')); ?>  							
							</h3>
						</div>
